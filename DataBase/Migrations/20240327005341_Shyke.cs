    ...
    public partial class Shyke : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemImages", x => new { x.ID, x.Path });
                    table.ForeignKey(
                        name: "FK_IMG_SP",
                        column: x => x.ID,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b7b7d8aa-0a61-483f-b37b-95cede7212b3"), "Phúc Diễn, Bắc Từ Liêm, Hà Nội", "nhatvu@gmail.com", "Nguyễn Lê Nhất Vũ", "2004-01-01", "19112004", 1, "0865805582", 0, "shyke" });
